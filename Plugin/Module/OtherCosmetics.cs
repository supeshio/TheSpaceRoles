    ...
    public static class OtherCosmetics
    {
            ...
            SkinsTab skinTab)
        {
            ...
            for (var i = 0; i < skins.Count; i++)
            {
                ...
                colorChip.Inner.SetHat(skin.BundleId, skinTab.HasLocalPlayer() ? PlayerControl.LocalPlayer.Data.DefaultOutfit.ColorId : DataManager.Player.Customization.Color);
